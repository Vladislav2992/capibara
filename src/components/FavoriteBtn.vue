...
const addToFavorites = () => isFavorite.value = !isFavorite.value
</script>
<template>
    <button @click.prevent="addToFavorites" class="favorite-btn">
        <svg :class="{ 'active': isFavorite }" width="24" height="21" viewBox="0 0 24 21" fill="none"
